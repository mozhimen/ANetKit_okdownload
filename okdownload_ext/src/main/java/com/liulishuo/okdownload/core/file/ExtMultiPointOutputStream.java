...
/**
 * @ClassName CustomMultiPointOutputStream
 * @Description TODO
 ...
 */
public class ExtMultiPointOutputStream extends MultiPointOutputStream {
    private static final String TAG = "CustomMultiPointOutputStream";
    private final DownloadTask task;

    ExtMultiPointOutputStream(final DownloadTask task, BreakpointInfo info, DownloadStore store, Runnable syncRunnable) {
        super(task, info, store, syncRunnable);
        this.task = task;
    }

    public ExtMultiPointOutputStream(DownloadTask task, BreakpointInfo info, DownloadStore store) {
